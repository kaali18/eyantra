...
class VisionAndTFPublisher(Node):
    ...
    def __init__(self):
        ...
        # 🆕 Added depth image subscription from code 2
        self.create_subscription(
    ...
    # 🆕 Added depth image callback from code 2
            ...
            if max_movement > self.movement_threshold:
                if not self.robot_is_moving:
                    ...
                    self.get_logger().info(
                        f'🤖 Robot movement detected! Stopping new fruit detections. '
    ...
    # 🆕 Bad fruit detection logic from code 2
